// // pages/auther/blog/create-blog.js
// "use client";
...
//   return (
//     <div className="min-h-screen w-full bg-gradient-to-br from-blue-50 via-purple-50 to-pink-50 flex items-center justify-center p-8"> {/* Increased padding */}
//       <motion.div
...
//               >
//                 <SelectTrigger className="w-full border border-gray-200 rounded-lg focus:border-blue-500 focus:ring-0 bg-white text-gray-800 transition-all duration-300 shadow-sm hover:shadow-md">
...
//                       />
//                       <Label htmlFor={`tag-${tag}`} className="cursor-pointer text-gray-800 font-medium">{tag}</Label>
//                     </div>
//                   ))}
//                 </motion.div>
//               )}
